...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.16 2014-03-21 08:02:41 GMT")
...
SOAP_FMAC3 void SOAP_FMAC4 soap_default_Damis__SOMMDSResponse(struct soap *soap, struct Damis__SOMMDSResponse *a)
{
	...
	soap_default_std__string(soap, &a->Y);
	soap_default_double(soap, &a->calcTime);
	soap_default_double(soap, &a->algorithmErrorQuantization);
	soap_default_double(soap, &a->algorithmErrorMDS);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_Damis__SOMMDSResponse(struct soap *soap, const char *tag, int id, const struct Damis__SOMMDSResponse *a, const char *type)
{
	...
	if (soap_out_double(soap, "calcTime", -1, &a->calcTime, ""))
		return soap->error;
	if (soap_out_double(soap, "algorithmErrorQuantization", -1, &a->algorithmErrorQuantization, ""))
		return soap->error;
	if (soap_out_double(soap, "algorithmErrorMDS", -1, &a->algorithmErrorMDS, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 struct Damis__SOMMDSResponse * SOAP_FMAC4 soap_in_Damis__SOMMDSResponse(struct soap *soap, const char *tag, struct Damis__SOMMDSResponse *a, const char *type)
{
	size_t soap_flag_Y = 1;
	size_t soap_flag_calcTime = 1;
	size_t soap_flag_algorithmErrorQuantization = 1;
	size_t soap_flag_algorithmErrorMDS = 1;
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			if (soap_flag_algorithmErrorQuantization && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_double(soap, "algorithmErrorQuantization", &a->algorithmErrorQuantization, "xsd:double"))
				{	soap_flag_algorithmErrorQuantization--;
					continue;
				}
			if (soap_flag_algorithmErrorMDS && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_double(soap, "algorithmErrorMDS", &a->algorithmErrorMDS, "xsd:double"))
				{	soap_flag_algorithmErrorMDS--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
				soap->error = soap_ignore_element(soap);
	...
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_Y > 0 || soap_flag_calcTime > 0 || soap_flag_algorithmErrorQuantization > 0 || soap_flag_algorithmErrorMDS > 0))
	{	soap->error = SOAP_OCCURS;
		return NULL;
	}
	return a;
