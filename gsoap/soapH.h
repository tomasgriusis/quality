...
inline struct Damis__SOMMDSResponse * soap_new_req_Damis__SOMMDSResponse(struct soap *soap, std::string& Y, double calcTime, double algorithmError) { struct Damis__SOMMDSResponse *_p = soap_instantiate_Damis__SOMMDSResponse(soap, -1, NULL, NULL, NULL); if (_p) { soap_default_Damis__SOMMDSResponse(soap, _p); _p->Y = Y; _p->calcTime = calcTime; _p->algorithmError = algorithmError; } return _p; }
